...
- Download Plug-in: [Stable Version](https://github.com/RatingPosterDB/RPDB-Media-Agent.bundle/releases/download/v0.0.5/RPDB-Media-Agent.bundle.zip) / [Beta Version](https://github.com/RatingPosterDB/RPDB-Media-Agent.bundle/releases/download/v0.0.6/RPDB-Media-Agent.bundle.zip)
